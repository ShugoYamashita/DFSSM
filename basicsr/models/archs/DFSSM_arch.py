...
class FSSB(nn.Module):
    def __init__(
        ...
        self.ln_1 = norm_layer(hidden_dim)
        self.self_attention = SS2D(d_model=hidden_dim, d_state=d_state,expand=expand,dropout=attn_drop_rate, **kwargs)
        self.fft_block = FFTM(hidden_dim, squeeze_factor=fftm_squeeze_factor)
        self.drop_path = DropPath(drop_path)
        self.skip_scale= nn.Parameter(torch.ones(hidden_dim))
        self.conv_blk = MGCB(hidden_dim)
        self.ln_2 = nn.LayerNorm(hidden_dim)
...
class OneStage(nn.Module):
    def __init__(self, hidden_dim, drop_path, norm_layer, attn_drop_rate, expand, d_state, num_blocks, fftm_squeeze_factor=2, num_fft_block=1, **kwargs):
        super().__init__()
        ...
        self.fftvss_block = nn.ModuleList([
            FSSB(
                ...
                expand=expand,
                d_state=d_state,
                fftm_squeeze_factor=fftm_squeeze_factor,
            )
...
class DFSSM(nn.Module):
    def __init__(self,
                 ...
                 mlp_ratio=1.5,
                 drop_path_rate=0.,
                 num_fssb_blocks=[1, 1, 1, 1, 1, 1, 1, 1],
                 fftm_squeeze_factor=2,
                 bias=False,
                 **kwargs,
                 ):
        ...
        self.encoder_level1 = nn.ModuleList([
            OneStage(
                ...
                num_fft_block=num_fssb_blocks[0],
                fftm_squeeze_factor=fftm_squeeze_factor,
        ...
        self.encoder_level2 = nn.ModuleList([
            OneStage(
                ...
                num_fft_block=num_fssb_blocks[1],
                fftm_squeeze_factor=fftm_squeeze_factor,
        ...
        self.encoder_level3 = nn.ModuleList([
            OneStage(
                ...
                expand=self.mlp_ratio,
                d_state=int(base_d_state * 2 ** 2),
                num_fft_block=num_fssb_blocks[2],
                fftm_squeeze_factor=fftm_squeeze_factor,
        ...
        self.latent = nn.ModuleList([
            OneStage(
                ...
                expand=self.mlp_ratio,
                d_state=int(base_d_state * 2 ** 2),
                num_fft_block=num_fssb_blocks[3],
                fftm_squeeze_factor=fftm_squeeze_factor,
        ...
        self.decoder_level3 = nn.ModuleList([
            OneStage(
                ...
                expand=self.mlp_ratio,
                d_state=int(base_d_state * 2 ** 2),
                num_fft_block=num_fssb_blocks[4],
                fftm_squeeze_factor=fftm_squeeze_factor,
        ...
        self.decoder_level2 = nn.ModuleList([
            OneStage(
                ...
                expand=self.mlp_ratio,
                d_state=int(base_d_state * 2 ** 2),
                num_fft_block=num_fssb_blocks[5],
                fftm_squeeze_factor=fftm_squeeze_factor,
        ...
        self.decoder_level1 = nn.ModuleList([
            OneStage(
                ...
                expand=self.mlp_ratio,
                d_state=int(base_d_state * 2 ** 2),
                num_fft_block=num_fssb_blocks[6],
                fftm_squeeze_factor=fftm_squeeze_factor,
        ...
        self.refinement = nn.ModuleList([
            OneStage(
                ...
                expand=self.mlp_ratio,
                d_state=int(base_d_state * 2 ** 2),
                num_fft_block=num_fssb_blocks[7],
                fftm_squeeze_factor=fftm_squeeze_factor,
